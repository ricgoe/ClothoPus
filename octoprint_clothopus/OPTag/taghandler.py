...
if __name__ == "__main__":
    pth = PrintTagHandler()
    pth.current_record = bytearray(b'\xe1@\'\x01\x03\xff\x01/\x91\x01\x17U\x043dtag.org/s/c38f06345dR\x1c\xf5application/vnd.openprinttag\xa1\x02\x18\xd2\xbf\x04\x1b\x00\x00\x07\xd0\xfc\xabFV\x05jc38f06345d\x08\x00\t\x01\nqPETG Prusa Orange\x0biPrusament\x0e\x1ah\xf9\x0e\xa3\x10\x19\x03\xe8\x11\x19\x03\xf9\x12\x19\x01\x15\x13C\xebT\x05\x18\x1c\x9f\xff\x18\x1d\xf9=\x14\x18"\x18\xf0\x18#\x19\x01\x04\x18$\x18\xaa\x18%\x18F\x18&\x18Z\x18\'\x12\x18(\x18<\x18)\x18#\x18*\x18C\x18+\x18\xc8\x18,\x18e\x18-\x183\x185\x1a\x00\x05\x04\xf3\x186')
    # a = {'data': {'main': {'material_class': 'FFF', 'material_type': 'PETG', 'material_name': 'PETG Prusa Orange', 'brand_name': 'Prusament'}}}
    # pth.patch_bin(a)
    c = {'data': {'aux': {'consumed_weight': 50}}}
    pth.patch_bin(c)
